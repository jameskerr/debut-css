...
export class DebutEffect {
  ...
  // Unlike set(), this is intentionally not gated on animation.isCurrent:
  // Animation.current() calls it to tear down a superseded animation's
  // classes, at which point it is by definition no longer current.
  reset() {
